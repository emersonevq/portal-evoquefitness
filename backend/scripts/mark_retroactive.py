...
def marcar_retroativos(db: Session) -> None:
    ...
    data_corte = datetime(2026, 2, 13)

    # Buscar todos os chamados ANTES de 2026-02-13 que NÃO foram marcados como retroativo
    ...
    print(f"  • Válidos para SLA (13-02-2026+): {ativos_2026}")
    print()
...
def main():
    ...
    try:
        ...
        print("    com data_abertura ANTES de 13-02-2026")
